...
async def _(event):
    ...
    await event.edit(f'''
**❖ Hi in the best checker in tele
❖ Version : 1.0
❖ Ping : {ms}
❖ Date : {m9zpi}
❖ ID : {event.sender_id}
❖ fifthon channel: @fifthon**
''')
...
async def update(event):
    ...
    await fifthon.send_message("me", "`اشتغل يلا بعبص براحتك`")
